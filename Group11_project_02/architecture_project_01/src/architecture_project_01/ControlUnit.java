...
public class ControlUnit {
	...
	public boolean singleCircle() {
		...
		//mGUI.CCR0_Label.setText(Integer.toBinaryString(register_CCR.CCR[0]));
		//mGUI.CCR1_Label.setText(Integer.toBinaryString(register_CCR.CCR[1]));
		//mGUI.CCR2_Label.setText(Integer.toBinaryString(register_CCR.CCR[2]));
		//mGUI.CCR3_Label.setText(Integer.toBinaryString(register_CCR.CCR[3]));
		return true;
	}
