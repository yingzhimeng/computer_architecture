...
public class mGUI extends JFrame {
	...
	private void setListeners() {
		...
		Instruction_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cache.init();
				//input the values of memory
				//memory.memory_arr[100] = 15424; //LDR OPCODE:0000010000000101
				
				//memory.memory_arr[101] = 2310; //STR OPCODE:0000100100000110
				//memory.memory_arr[102] = 3591; //LDA OPCODE:0000111000000111
				//memory.memory_arr[103] = 42048; //LDX OPCODE:1010010001100001
				//memory.memory_arr[104] = 43087;//STX
				//memory.memory_arr[105] = 4639;//AMR
				//memory.memory_arr[106] = 5248;//SMR
				//memory.memory_arr[107] = 6272;//AIR
				//memory.memory_arr[108] = 7296;//SIR
				//memory.memory_arr[109]=10304;//JZ
				//memory.memory_arr[110]=11264;//JNE
				//memory.memory_arr[112]=12352;//JCC
				//memory.memory_arr[113]=13376;//JMA
				//memory.memory_arr[114]=14400;//JSR
				//memory.memory_arr[115]=15424;//RFS
				//memory.memory_arr[100]=16448;//SOB
				//memory.memory_arr[100]=17472;//JGE
				//memory.memory_arr[100]=20544;//MLT
				//memory.memory_arr[100]=21568;//DVD
				//memory.memory_arr[100]=22592;//TRR
				//memory.memory_arr[100]=23616;//AND
				//memory.memory_arr[100]=58202;//ORR
				//memory.memory_arr[123]=60202;//NOT
				memory.memory_arr[100]=32832;//SRC
				//memory.memory_arr[100]=31808;//RRC
				//memory.memory_arr[100]=59392;//IN
				//memory.memory_arr[100]=63488;//OUT
				//memory.memory_arr[100]=64576;//CHK
				...
				//CCR
				CCR0_Label.setText(Integer.toString(register_CCR.CCR[0]));
				CCR1_Label.setText(Integer.toString(register_CCR.CCR[1]));
				CCR2_Label.setText(Integer.toString(register_CCR.CCR[2]));
				CCR3_Label.setText(Integer.toString(register_CCR.CCR[3]));
			}
		});
		...
		input_text.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				if(input_text.getText().length()>"65535".length())
				{
					input_text.setText("");
				}
				else
	...
	public JPanel addComponents(java.awt.Container con) {
		...
		input_text.setBounds(300, 190, 250, 20);
		this.add(input_text);
		...
		Instruction_Button.setBounds(310, 350, 200, 20);
		this.add(Instruction_Button);
		...
		p1_Button.setBounds(310, 310, 110, 20);
		this.add(p1_Button);
		
		run_Button.setBounds(430, 310, 110, 20);
		this.add(run_Button);
	...
	static JLabel						CCR0_Label			= new JLabel("0");
	static JLabel						CCR1_Label			= new JLabel("0");
	static JLabel						CCR2_Label			= new JLabel("0");
	static JLabel						CCR3_Label			= new JLabel("0");
	...
	JButton						project1_test_BTN	= new JButton(
															"project1 test");
	JButton                     Instruction_Button=new JButton("Instruction Test");
