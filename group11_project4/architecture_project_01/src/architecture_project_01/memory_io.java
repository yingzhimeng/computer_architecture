...
public class memory_io extends memory{
	...
	static String file_name = "memory.txt";
	static String introduction = "This is the simulator memory file.\nThe first conlum is to record the memory address, "
